...
class Document:
	...
	def signDocs(self, x_pos, y_pos):
		...
		signature = Image.open(self.directory + "\\DocumentsPDFS\\files\\barry_signature_clean.jpg")
...
def sign_all(working_dir):
	...
	if confirm =='yes':
		try:
			bmr_y_pos = 908
			bmr_x_pos = 420
			bmr_file_in = "\\DocumentsPDFS\\files\\bmr.jpg"
			bmr_file_out = "\\DocumentsPDFS\\finals\\bmrFinale.jpg"
		...
		try:
			swor_front_y = 930
			swor_front_x = 1015
			west_front_file_in = "\\DocumentsPDFS\\files\\west_swor_front.jpg"
			west_front_file_out = "\\DocumentsPDFS\\finals\\west_swor_frontFinale.jpg"
		...
		try:
			swor_back_y = 938
			swor_back_x = 1000
			west_back_file_in = "\\DocumentsPDFS\\files\\west_swor_back.jpg"
			west_back_file_out = "\\DocumentsPDFS\\finals\\west_swor_backFinale.jpg"
		...
		try:
			swor_front_y = 930
			swor_front_x = 1015
			west_front_file_in = "\\DocumentsPDFS\\files\\east_swor_front.jpg"
			west_front_file_out = "\\DocumentsPDFS\\finals\\east_swor_frontFinale.jpg"
			west_front = Document(west_front_file_in, west_front_file_out, directory=working_dir)
			west_front.get_file()
			west_front.signDocs(swor_front_x, swor_front_y)
		except:
		...
		try:
			swor_back_y = 938
			swor_back_x = 1000
			west_back_file_in = "\\DocumentsPDFS\\files\\east_swor_back.jpg"
			west_back_file_out = "\\DocumentsPDFS\\finals\\east_swor_backFinale.jpg"
			west_back = Document(west_back_file_in, west_back_file_out, directory=working_dir)
			west_back.get_file()
			west_back.signDocs(swor_back_x, swor_back_y)
		except:
		...
		try:
			ifmr_y = 945
			ifmr_x = 170
			west_ifmr_first = "\\DocumentsPDFS\\files\\west_ifmr_page_one.jpg"
			west_ifmr_first_out = "\\DocumentsPDFS\\finals\\west_ifmr_page_oneFinale.jpg"
		...
		try:
			ifmr_two_y = 820
			ifmr_two_x = 170
			west_ifmr_second = "\\DocumentsPDFS\\files\\west_ifmr_page_two.jpg"
			west_ifmr_second_out = "\\DocumentsPDFS\\finals\\west_ifmr_page_twoFinale.jpg"
		...
		try:
			ifmr_y = 945
			ifmr_x = 170
			east_ifmr_first = "\\DocumentsPDFS\\files\\east_ifmr_page_one.jpg"
			east_ifmr_first_out = "\\DocumentsPDFS\\finals\\east_ifmr_page_oneFinale.jpg"
		...
		try:
			ifmr_two_y = 820
			ifmr_two_x = 170
			east_ifmr_second = "\\DocumentsPDFS\\files\\east_ifmr_page_two.jpg"
			east_ifmr_second_out = "\\DocumentsPDFS\\finals\\east_ifmr_page_twoFinale.jpg"
